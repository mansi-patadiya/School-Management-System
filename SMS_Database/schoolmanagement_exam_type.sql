...
CREATE TABLE `exam_type` (
  `examtype_id` tinyint NOT NULL AUTO_INCREMENT,
  `examtype_name` varchar(15) NOT NULL,
...
INSERT INTO `exam_type` VALUES (1,'First'),(2,'Second'),(3,'Third');
...
-- Dump completed on 2021-05-27 14:37:10
